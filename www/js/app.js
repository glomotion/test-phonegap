...
$(function(){
    ...
    // $('#scroller article').hammer().on('tap', function() {
    //     $body.removeClass('home').addClass('animate card-details');
    //     setTimeout(function() {
    //         $body.removeClass('animate');
    //     }, 220);
    // });

    // $('#card-details').hammer().on('tap', function() {
    //     $body.addClass('animate home').removeClass('card-details');
    //     setTimeout(function() {
    //         $body.removeClass('animate');
    //     }, 220);
    // });
